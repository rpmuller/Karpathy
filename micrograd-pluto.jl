...
# ╔═╡ d63900dc-01fa-45d5-b269-83c1dbb134b9
using Plots

# ╔═╡ 6d11926c-53d5-4bd3-8d08-ac0b6bda76a5
using Graphs

# ╔═╡ 3acfa32f-af81-4c87-a0de-f206baeb16fd
using GraphPlot

# ╔═╡ 29128eae-1525-11ef-003a-87d70c63adec
md"# Karpathy NN Zero to Hero"

# ╔═╡ 4a1dcbe7-e65f-4ff8-b377-12a51f48a3ca
md"
I'm going to attempt to redo (some of?) Karpathy's [Neural Nets: Zero to Hero](https://github.com/karpathy/nn-zero-to-hero) tutorials in Julia. 
...
# ╔═╡ f621f7a4-8712-4d39-8527-62c3e55563fb
import Base

# ╔═╡ 69ded565-ffa0-4d95-823a-dfd5c0e62438
md"
## Micrograd
...
# ╔═╡ 05ce0c32-aa09-494e-af32-7f0226cf6643
md"Understanding derivatives, creating functions, plotting them.

Julia has a nice syntax for creating functions in one line."

# ╔═╡ 7af90fd4-deee-48c1-9ccd-d9cd4ee56f46
md"""
These are (intentionally) type vague for now, so calling with an int returns an int, and calling with a float returns a float.
"""

# ╔═╡ ea57c9a5-5b1a-4f73-aeaa-0241b65d765f
md"Compute (numerical) derivatives of function"

# ╔═╡ 00b1abb8-fa62-4310-836b-ed9a64afbdd8
h = 0.00001

# ╔═╡ 341c349d-2a84-4207-a728-46a6c7ab43a7
x = 2/3

# ╔═╡ e7e45abb-39be-482d-9401-590ab6cf55c2
md"Pluto notebooks are dynamic, so we can just change x and h above to see different values."

# ╔═╡ 47352a37-023b-4b78-92c8-2258c33b8385
md"On to more complicated examples."
...
# ╔═╡ 4c1c8861-b334-4f1d-a96d-88dfe868767d
f(3)

# ╔═╡ fff461af-ac14-4d5d-a1e6-503f89e0271a
f(3.0)

# ╔═╡ 3e09f904-436a-422a-a928-765cf997746c
plot(-5:0.25:5,f, title="Plotting functions in Julia", label="f(x)")

# ╔═╡ b5ceb725-087f-42e2-9ea4-6ac3adca390e
f(x)

# ╔═╡ 1ecd3ebe-8297-4883-9a9c-02d8030010e0
f(x+h)
...
# ╔═╡ 98ddf949-6309-48ff-8ad1-3b5b5346626f
md"## Graph visualization package for Values
This starts in AK's video around 25:44.

Using Julia's [Graphs.jl](https://juliagraphs.org/Graphs.jl/dev/) package.
"

# ╔═╡ 45e649c1-3d8a-470d-859f-d65e27d79da9
...
# ╔═╡ 3f3d39d5-e2ef-41db-8c90-ddf3a37974a3
...
# ╔═╡ 3ac1c738-ba33-4bdc-b8f1-6c510c1b34a9
draw(d2)

# ╔═╡ 0e8e9300-6562-44f8-b831-90ebdb6e9059
md"## Back Propagation"

# ╔═╡ 1bebcd54-0de4-4288-a9ba-a104492f7747
md"""
Neural nets use the `tanh` activation function to squash response values to [-1,1].
"""

# ╔═╡ 39fb7336-d4e9-4eda-94e5-5814b40e2b21
plot(-5:0.1:5,tanh,label="tanh")

# ╔═╡ 31adc8c4-c41a-4276-ab3f-40f0b47a47c0
md"Manually create a neural net"

# ╔═╡ 86818418-400f-4d02-aafd-da964307d599
md"Inputs:"

# ╔═╡ b4174d5a-66d5-4548-b9d2-877ed1b58672
x1 = Value(2.0,"x1")

# ╔═╡ a7720dd3-7bcc-43dd-bb15-3741ac356942
x2 = Value(0.0,"x2")

# ╔═╡ e0efb196-02cb-460b-9e6c-90d4dde5a20f
md"Weights:"

# ╔═╡ 86f5d088-da0a-4063-b708-f64a9f32bf76
w1 = Value(-3.0,"w1")

# ╔═╡ 9ee81a0f-bd5e-401b-8062-cde48fac0485
w2 = Value(1.0,"w2")

# ╔═╡ 092a8627-cc0b-4745-8fee-4b7adc379ac7
md"Bias:"

# ╔═╡ ac95ab49-1cb7-4060-aed4-fd0a32abc416
b = Value(6.88137358,"b")

# ╔═╡ b17d3dfb-c264-478f-9d54-ea4dad3a6c46
md"Create network:"

# ╔═╡ 26998209-9581-4bea-820b-5c7ebe8a33c3
begin
	x1w1 = x1*w1
	x2w2 = x2*w2
	x1w1x2w2 = x1w1+x2w2
...
# ╔═╡ 724a2a91-b67d-466f-8b8d-b8602e97b7eb
draw(o)

# ╔═╡ f4df1aa3-5c26-4111-893e-5fd5188dd9f6
o.grad

# ╔═╡ dad73e54-4260-482e-a930-2e4bdef9427b
backprop(o)

# ╔═╡ c05524fb-a4f2-4a08-9487-27aafd9e6e3e
b.grad

# ╔═╡ 1cac0d8c-c410-4e43-b5fd-6c02d5d35906
x2.grad

# ╔═╡ 4cdb94cd-e1fb-4079-8363-7e48e0de016b
x1.grad

# ╔═╡ 7a5427ba-4682-4d91-a6f1-f69c82122bcc
md"AK says there is a bug (1:22 of video):"

# ╔═╡ 33005d2c-598a-48aa-bbc8-a1aea441da02
abug = Value(3.0,"a")

# ╔═╡ 1429b0fa-7230-42a9-99dc-54f40a4ef3ef
bbug = abug + abug

# ╔═╡ 647bf2ea-debc-4a48-9ba8-fc7aac9f1502
backprop(bbug)

# ╔═╡ 308803be-47fc-4863-85d8-e7a19e584e8f
draw(bbug)

# ╔═╡ 46efc9df-077a-4f25-adcc-1c514ee4c395
md"The gradient isn't correct"

# ╔═╡ f45029e1-e123-4717-aee7-3301d2727005
abug.grad

# ╔═╡ aa941726-c06a-4533-abd4-003df36dfeba
bbug.grad
